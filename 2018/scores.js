...
var predatorsRec   = [  9,  5,  5, 3 ];   // Joe
var fatbastardsRec = [  8,  6,  5, 3 ];   // Steve
var belicheckRec   = [  7,  7,  6, 2 ];   // Steve
var cookiemonRec   = [  6,  8,  4, 4 ];   // Noah
var krustyRec      = [  1, 13,  0, 8 ];   // Hunter

var iceotopesRec   = [ 13,  1,  7, 1 ];   // John
var ingloriousRec  = [  9,  5,  5, 3 ];   // Matt
var thenubsRec     = [  7,  7,  3, 5 ];   // Adam
var rolltideRec    = [  6,  8,  3, 5 ];   // Daniel
var tenanusRec     = [  4, 10,  2, 6 ];   // Jake
...
var week14_txt = "And so it ends (the regular season that is).  The unfathomable Bastard story continues as they inexplicbly win again and secure " +
                 "the last playoff spot, much to the Nubs consternation who wouldv'e been in if nor for the Turds.  And congrats to the Preds for " +
                 "securing their division. As for the rest, you'all be sad to season go (except maybe for the Krustys) and dream all winter of maybe " +
                 "beating the Turds next year...";
